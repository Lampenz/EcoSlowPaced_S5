...
namespace Eco.Mods.TechTree
{
    ...
    [Weight(250)] // Defines how heavy the Coconut is.
    [Yield(typeof(CoconutItem), typeof(GatheringSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("A milky fruit that grows on a palm tree.")] //The tooltip description for the food item.
    public partial class CoconutItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 1, Fat = 3, Protein = 2, Vitamins = 3};
