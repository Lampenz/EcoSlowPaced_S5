        ...
        public BigBagRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(OutpostNettingItem), 2, typeof(TailoringSkill)), // Added moring rope (20250729, Lampenz.)
                },
    ...
    public partial class PaletteRecipe : RecipeFamily
    {
        public PaletteRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("Wood", 20, typeof(CarpentrySkill), typeof(CarpentryLavishResourcesTalent)),      // Added Wood (20250729-Lampenz)
                    ...
                    new IngredientElement(typeof(NailItem), 20, typeof(BlacksmithSkill)),                                   // Added nails (20250729-Lampenz)
                },
    ...
    public partial class StockageOutilsRecipe : RecipeFamily
    {
        public StockageOutilsRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("HewnLog", 8, typeof(CarpentrySkill), typeof(CarpentryLavishResourcesTalent)), // Recette personnalisable : "5" Hewnlog.
    ...
    public partial class Petite_Simple_EtagereRecipe : RecipeFamily
    {
        public Petite_Simple_EtagereRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(NailItem), 10, typeof(MechanicsSkill), typeof(MechanicsLavishResourcesTalent)), // Recette personnalisable : "5" Clous.
    ...
    public partial class Petite_Double_EtagereRecipe : RecipeFamily
    {
        public Petite_Double_EtagereRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(NailItem), 20, typeof(MechanicsSkill), typeof(MechanicsLavishResourcesTalent)), // Recette personnalisable : "10" Clous.
        ...
        public PetitStockageWoodRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(NailItem), 10, typeof(BlacksmithSkill)),                                   // Added nails (20250729-Lampenz)    
                },
        ...
        public MoyenStockageWoodRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(NailItem), 25, typeof(BlacksmithSkill)),                                   // Added nails (20250729-Lampenz)
                },
