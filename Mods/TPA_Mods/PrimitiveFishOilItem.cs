...
namespace Eco.Mods.TechTree
{
    ...
    {
        public PrimitiveFishOilRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PrimitiveFishOil",  //noloc
                displayName: Localizer.DoStr("Primitive Fish Oil"),
            ...
            this.Initialize(displayText: Localizer.DoStr("Oil"), recipeType: typeof(PrimitiveFishOilRecipe));
