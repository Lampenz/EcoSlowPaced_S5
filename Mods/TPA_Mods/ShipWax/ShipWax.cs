...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "Ship wax" item.</para>
    ...
    [Weight(150)] // Defines how heavy WoodenHullPlanks is.
    [RepairRequiresSkill(typeof(ShipwrightSkill), 0)]
    [Ecopedia("Items", "Products", createAsSubPage: true)]
    [LocDescription("Shipwax made from coconut extract combined with wood resin")] //The tooltip description for the item.
