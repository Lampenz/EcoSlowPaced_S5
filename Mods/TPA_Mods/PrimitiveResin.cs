...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "PrimitiveResin" item.</para>
    ...
    [LocDisplayName("Primitive Resin")] // Defines the localized name of the item.
    ...
    public partial class PrimitiveResinRecipe : RecipeFamily
    {
        public PrimitiveResinRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PrimitveResin",  //noloc
                displayName: Localizer.DoStr("Primitive Resin"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PrimitiveResinRecipe), start: 1.5f, skillType: typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Grease"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Primitive Resin"), recipeType: typeof(WoodResinRecipe));
