...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SturdyWoodenPlanksRecipe : RecipeFamily
    {
        public SturdyWoodenPlanksRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SturdyWoodenPlanksRecipe), start: 1, skillType: typeof(ShipwrightSkill), typeof(ShipwrightFocusedSpeedTalent), typeof(ShipwrightParallelSpeedTalent));
