...
namespace Eco.Mods.TechTree
{
    ...
    public partial class PalmOilRecipe : RecipeFamily
    {
        public PalmOilRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PalmOil",  //noloc
                displayName: Localizer.DoStr("Palm seed Oil"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PalmOilRecipe), start: 1, skillType: typeof(MillingSkill), typeof(MillingFocusedSpeedTalent), typeof(MillingParallelSpeedTalent));
