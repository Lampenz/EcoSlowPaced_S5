...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ShippingResearchPaperBasic".</para>
    ...
    public partial class ShippingResearchPaperBasicRecipe : RecipeFamily
    {
        public ShippingResearchPaperBasicRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement("Wood", 20, typeof(ShipwrightSkill)), //noloc
                },
    ...
    /// <summary>
    /// <para>Server side item definition for the "ShippingResearchPaperBasic" item.</para>
